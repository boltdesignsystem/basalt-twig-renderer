...
class Parser
{
    ...
    private function filterBodyNodes(Node $node, bool $nested = false)
    {
        ...
        if (
            ...
            throw new SyntaxError('A template that extends another one cannot include content outside Twig blocks. Did you forget to put the content inside a {% block %} tag? '. $t, $node->getTemplateLine(), $this->stream->getSourceContext());
        }
